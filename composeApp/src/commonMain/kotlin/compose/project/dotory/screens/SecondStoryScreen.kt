...
fun SecondStoryScreen(navController: NavController, selectedItem: MutableState<Int>) {
    val storyText =
        "한경이는 여름날 숲 속을 산책하다, 말을 할 줄 아는 동물 친구들이 사는 신비로운 공간을 발견했어요. 사슴, 다람쥐, 올빼미, 여우가 다정하게 한경이를 맞이하며 함께 놀자고 초대했죠. 한경이는 동물들과 함께 숲을 탐험하며 즐겁게 놀았어요.\n" +
                ...
                "\n" +
                "며칠이 지나자, 숲은 다시 깨끗해졌고 공기도 맑아졌어요. 시냇물도 반짝이는 물결을 되찾았죠. 한경이와 친구들의 노력 덕분에 동물 친구들은 다시 평화로운 숲에서 행복하게 지낼 수 있게 되었어요.\n" +
                "\n" +
    ...
    Box(
        ...
        if (isLoading) {
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(10.dp)) // 이미지 위쪽 패딩
                ...
                Text(
                    ...
                    modifier = Modifier
                        .fillMaxWidth()
                        .padding(bottom = 200.dp) // 이미지 아래쪽 패딩
                )

                Spacer(modifier = Modifier.height(10.dp)) // 추가 하단 공간
            }
